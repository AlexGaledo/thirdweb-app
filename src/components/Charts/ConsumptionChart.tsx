...
const ConsumptionChart: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Tooltip */}
      {hoverIndex !== null && (
        <div className="absolute -mt-2 p-2 bg-neutral-800 border border-neutral-700 text-sm rounded text-white z-10" style={{ left: `${(hoverIndex / (data.length - 1)) * 100}%`, transform: 'translateX(-50%)' }}>
